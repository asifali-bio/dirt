...
DiRT was created to bridge the gap between computational biology workflows and modern rendering platforms.
...
DiRT provides a simple, standardized pathway for exporting biological data into visualization environments without tightly coupling analysis code to a specific rendering engine.

---

## Philosophy

DiRT is intentionally renderer-agnostic.
